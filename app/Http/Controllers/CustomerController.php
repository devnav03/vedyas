...
class CustomerController extends Controller {
    ...
    public function store( Request $request ){
        ...
        try{
            ...
            //     $message->to($email);
            //     $message->subject('New Account Created With vedyas');
            // }); 
       ...
       if(isset($category[4])){
           ...
           $cat_5 = 0;
              ...
              if($row['0']!=''){
                ...
                $description = str_replace("\x93", "", $description);
                $description = str_replace("\x99", "", $description);
                ...
                $product_description = str_replace("\x93", "", $product_description);
