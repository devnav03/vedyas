...
function live_product_2(Request $request) {
    ...
    $data = \DB::table('products')
        ...
        foreach($data as $row) {
        $output .= '
        <li><input value="'.$row->id.'" name="code_value" class="code_check" onChange="getProduct_Code_2(this.value);" type="radio"> <span>'.$row->name.' ('.$row->sku.')</span></li>
        ';
       }
      $data = array(
       'table_data'  => $output,
...
function live_product_3(Request $request) {
    if($request->ajax()) {
    $output = '';
    $query = $request->get('query');
    if($query != '') {
    $data = \DB::table('products')
        ...
        foreach($data as $row) {
        $output .= '
        <li><input value="'.$row->id.'" name="code_value" class="code_check" onChange="getProduct_Code_3(this.value);" type="radio"> <span>'.$row->name.' ('.$row->sku.')</span></li>
        ';
       }
      $data = array(
       'table_data'  => $output,
...
function live_product_4(Request $request) {
    if($request->ajax()) {
    $output = '';
    $query = $request->get('query');
    if($query != '') {
    $data = \DB::table('products')
        ...
        foreach($data as $row) {
        $output .= '
        <li><input value="'.$row->id.'" name="code_value" class="code_check" onChange="getProduct_Code_4(this.value);" type="radio"> <span>'.$row->name.' ('.$row->sku.')</span></li>
        ';
       }
      $data = array(
       'table_data'  => $output,
...
function live_product_5(Request $request) {
    if($request->ajax()) {
    $output = '';
    $query = $request->get('query');
    if($query != '') {
    $data = \DB::table('products')
        ...
        foreach($data as $row) {
        $output .= '
        <li><input value="'.$row->id.'" name="code_value" class="code_check" onChange="getProduct_Code_5(this.value);" type="radio"> <span>'.$row->name.' ('.$row->sku.')</span></li>
        ';
       }
      $data = array(
       'table_data'  => $output,
...
function live_product_6(Request $request) {
    if($request->ajax()) {
    $output = '';
    $query = $request->get('query');
    if($query != '') {
    $data = \DB::table('products')
        ...
        foreach($data as $row) {
        $output .= '
        <li><input value="'.$row->id.'" name="code_value" class="code_check" onChange="getProduct_Code_6(this.value);" type="radio"> <span>'.$row->name.' ('.$row->sku.')</span></li>
        ';
       }
      $data = array(
       'table_data'  => $output,
...
function live_product_7(Request $request) {
    if($request->ajax()) {
    $output = '';
    $query = $request->get('query');
    if($query != '') {
    $data = \DB::table('products')
        ...
        foreach($data as $row) {
        $output .= '
        <li><input value="'.$row->id.'" name="code_value" class="code_check" onChange="getProduct_Code_7(this.value);" type="radio"> <span>'.$row->name.' ('.$row->sku.')</span></li>
        ';
       }
      $data = array(
       'table_data'  => $output,
...
function live_product_8(Request $request) {
    if($request->ajax()) {
    $output = '';
    $query = $request->get('query');
    if($query != '') {
    $data = \DB::table('products')
        ...
        foreach($data as $row) {
        $output .= '
        <li><input value="'.$row->id.'" name="code_value" class="code_check" onChange="getProduct_Code_8(this.value);" type="radio"> <span>'.$row->name.' ('.$row->sku.')</span></li>
        ';
       }
      $data = array(
       'table_data'  => $output,
    ...
    public function check_product_code(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
            $data['product_sku'] = $code->sku;
            $data['price'] = $code->offer_price;
            return $data;
        }
        else{
            $ab['status'] = 'Fail';
    ...
    public function check_product_code_2(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
    ...
    public function check_product_code_3(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
    ...
    public function check_product_code_4(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
    ...
    public function check_product_code_5(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
    ...
    public function check_product_code_6(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
    ...
    public function check_product_code_7(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
    ...
    public function check_product_code_8(Request $request){
        $code = Product::where('id', $request->code)->where('status', 1)->select('id', 'name', 'sku', 'offer_price')->first();
        if($code){
            $data['product_name'] = $code->name;
            $data['product_id'] = $code->id;
