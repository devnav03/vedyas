...
Route::get('/admin/vedyas/admin-login', 'Auth\AuthController@getLogin')->name('admin');
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::any('gst-calculation', 'DashboardController@gst_calculation')->name('gst-calculation'); 
           ...
           // Category route start
            ...
            Route::get('check_product_code_2', 'ProductController@check_product_code_2')->name('check_product_code_2');
            Route::get('check_product_code_3', 'ProductController@check_product_code_3')->name('check_product_code_3');
            Route::get('check_product_code_4', 'ProductController@check_product_code_4')->name('check_product_code_4');
            Route::get('check_product_code_5', 'ProductController@check_product_code_5')->name('check_product_code_5');
            Route::get('check_product_code_6', 'ProductController@check_product_code_6')->name('check_product_code_6');
            Route::get('check_product_code_7', 'ProductController@check_product_code_7')->name('check_product_code_7');
            Route::get('check_product_code_8', 'ProductController@check_product_code_8')->name('check_product_code_8');


            Route::get('check_product_code_9', 'ProductController@check_product_code_9')->name('check_product_code_9');
            Route::get('check_product_code_10', 'ProductController@check_product_code_10')->name('check_product_code_10');
            Route::get('check_product_code_11', 'ProductController@check_product_code_11')->name('check_product_code_11');
            Route::get('check_product_code_12', 'ProductController@check_product_code_12')->name('check_product_code_12');
            Route::get('check_product_code_13', 'ProductController@check_product_code_13')->name('check_product_code_13');
           ...
           //Blog Start
            ...
            Route::any('reviews/paginate/{page?}', ['as' => 'reviews.paginate',
                'uses' => 'ReviewsController@reviewsPaginate']);
            Route::any('reviews/action', ['as' => 'reviews.action',
                'uses' => 'ReviewsController@reviewsAction']);
            Route::any('reviews/toggle/{id?}', ['as' => 'reviews.toggle',
                'uses' => 'ReviewsController@reviewsToggle']);
            Route::any('reviews/drop/{id?}', ['as' => 'reviews.drop',
                'uses' => 'ReviewsController@drop']);
            // reviews route end
        ...
        Route::get('live_product_1', 'ProductController@live_product_1')->name('live_product_1');
        Route::get('live_product_2', 'ProductController@live_product_2')->name('live_product_2');
        Route::get('live_product_3', 'ProductController@live_product_3')->name('live_product_3');
        Route::get('live_product_4', 'ProductController@live_product_4')->name('live_product_4');
        Route::get('live_product_5', 'ProductController@live_product_5')->name('live_product_5');
        Route::get('live_product_6', 'ProductController@live_product_6')->name('live_product_6');
        Route::get('live_product_7', 'ProductController@live_product_7')->name('live_product_7');
        Route::get('live_product_8', 'ProductController@live_product_8')->name('live_product_8');
        Route::get('live_product_9', 'ProductController@live_product_9')->name('live_product_9');
        Route::get('live_product_10', 'ProductController@live_product_10')->name('live_product_10');
        Route::get('live_product_11', 'ProductController@live_product_11')->name('live_product_11');
        Route::get('live_product_12', 'ProductController@live_product_12')->name('live_product_12');
        Route::get('live_product_13', 'ProductController@live_product_13')->name('live_product_13');
        Route::get('live_product_14', 'ProductController@live_product_14')->name('live_product_14');
        Route::get('live_product_15', 'ProductController@live_product_15')->name('live_product_15');
...
//Review Start
Route::post('submit_review_store', 'Frontend\HomeController@reviewStore')->name('submit_review_store');
