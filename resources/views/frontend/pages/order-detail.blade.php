                  ...
                  <div class="col-md-6">
                    ...
                    <h6 class="shipping_hd">Order Summary</h6>
                      <div class="summary-box">
                        ...
                        <div class="col-5">
                          <p class="mb-1"><i class="fa fa-dollar"></i>{{ number_format($total_pr1) }} </p>
                        </div>
                        <div class="col-7">
                            <p class="mb-1" style="text-transform: uppercase;">Shipping:</p>
                        </div>
                        <div class="col-5">
                            <p class="mb-1"><i class="fa fa-dollar"></i>{{ number_format($order->shipping_price, 2) }}</p>
                        </div>

                        <div class="col-7">
                            <p class="mb-1" style="text-transform: uppercase;">Tax:</p>
                        </div>
                        <div class="col-5">
                            <p class="mb-1"><i class="fa fa-dollar"></i>{{ number_format($order->shipping_tax+$order->product_tax, 2) }}</p>
                        </div>
