      ...
      <div class="col-md-5 offset-md-1">
        ...
        @endphp
          ...
          @php
            ...
            $product_t = DB::table('products')->where('id', $cart_product->pid)->select('tax')->first(); 
  ...
  $total_pay_amout = (int)$total_pay_amount; @endphp
            ...
            @if($sale_price != 0)
             ...
             <!--  <p>Item(s) Price <span id="total_list_price"> <i class="fa fa-dollar"></i>{{ $list_price }}</span></p> -->
              ...
              <p style="border-bottom: 1px solid #d6d6d6; padding-bottom: 10px;font-weight: 500; color: #000; ">Tax <span style="float: right;font-weight: 500; color: #000;" id="total_tax">  $<span id="shipping_tax_price">{{ number_format($shipping_tax_price + $product_tax_price, 2) }}</span></span></p>

              <p style="font-size: 18px; font-weight: 600; color: #000; padding-top: 3px;border-bottom: 2px solid #ccc; padding-bottom: 10px;">Total <span  style="color: #000; float: right; ">$<span id="total_sale_price_cart1">{{ number_format($sale_price+$shipping_price+$shipping_tax_price+$product_tax_price, 2) }}</span></span></p>
              </div>
