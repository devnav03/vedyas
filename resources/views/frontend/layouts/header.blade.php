    ...
    <img class="logo-white d-none" src="{!! asset('assets/frontend/images/logo.png') !!}" alt="Logo"></a></h1></div>
          <div class="col-sm-3 col-md-4 col-3 header-top__right">
            ...
            <div class="site-header__search-wrap">
              ...
              <form id="form-search-header" method="get" action="{{ route('search_product')}}"   class="site-header__search js-ajaxsearch" role="search" style="position: relative;">
                <div class="container py-4">
                  <div class="row">
                    <div class="col-12">

                    <button onclick="toggleClassSearchREm(); return false;" class="text-link site-header__link site-header__search-pop"><i class="fa-solid fa-xmark"></i></button>
                      ...
                      <div class="d-flex align-items-center pb-lg-2 border-bottom">
                        <input onfocus="this.value=''" type="text" name="q" id="transcript" autocomplete="off" @if(isset($search_key)) value="{{ $search_key }}" @endif  placeholder="Search Products..." class="main-search site-header__search-input mr-auto">
