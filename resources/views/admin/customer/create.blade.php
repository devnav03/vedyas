            ...
            <div class="col-md-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="margin-top: 20px;">
                                        ...
                                        <label>Pay Later</label>
                                            <select name="pay_later" class="select2 form-control1" required="true">
                                                <option value="">-Select-</option>
                                                @if(isset($result))
                                                <option @if($result->pay_later==1) selected @endif value="1">Yes</option>
                                                <option @if($result->pay_later==0) selected @endif value="0">No</option>
                                                @else
                                                <option {{ old('pay_later') == '1' ? 'selected' : '' }} value="1">Yes</option>
                                                <option {{ old('pay_later') == '0' ? 'selected' : '' }} value="0">No</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div>
              ...
              <div class="col-md-4">
                ...
                <p> {{ $user_address->billing_street_address }} {{ $user_address->billing_street_address2 }}, {{ $user_address->billing_suburb }}, 
                  {{ $user_address->billing_postcode }} <br> Phone: {{ $user_address->billing_phone }} <br> Phone: {{ $user_address->billing_email_address }} </p>
              </div>
              </div>
              @endif
              @endforeach
