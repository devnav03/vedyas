    ...
    <div style="float: left; width: 100%; min-height: 300px; border: 1px solid #004c69;">
      ...
      <div style="float: left; width: 100%; height: 100%; border-bottom: 1px solid #004c69; margin: 15px auto 0px auto;">
        <div style="float: left; width: 49%;padding-left:10px;">
          ...
          <p style="float: left; color: #000; margin: 10px 0px 2px 0px; font-size: 14px; margin-top: -1px;">Wishmed</p>
        ...
        <div style="float: right; text-align: right; width: 47%;padding-right:10px;">
          ...
          <h4 style="font-weight: 600; float: right; color: #004c69; margin: 0px;width: 100%;">Card  Details:</h4>
          <p style="float: right; color: #000; margin: 10px 0px 0px 0px; font-size: 13px;">  
          Card No: XXXX {{ substr($current_order->card_no, 4, 4) }} {{ substr($current_order->card_no, 8, 4) }} XXXX </p>
          <p style="float: right; color: #000; margin: 1px 0px 0px 0px; font-size: 13px;">  
          Card Holder: {{$current_order->card_holder}}</p>
          <p style="float: right; color: #000; margin: 0px 0px 0px 0px; font-size: 13px;">  
          Card Type: {{$current_order->card_type}}</p>
          <p style="float: right; color: #000; margin: 0px 0px 0px 0px; font-size: 13px;">  
          Expiration date: {{$current_order->expiration_month}}/{{$current_order->expiration_year}}</p>
          <p style="float: right; color: #000; margin: 0px 0px 5px 0px; font-size: 13px;">  
          Card Security Code: {{$current_order->card_security_code}}</p>
      ...
      <div style="float: left; width: 100%; height: 100%; margin: 20px auto 0px auto;">
        ...
        <div style="float: right; text-align: right; width: 48%;padding-right:10px;">
        ...
        <table style="width: 100%; border-spacing: 0px; text-align: center;">
          <thead>
                 <tr style="margin:0px; padding: 0px;">
                    <th style="border-bottom: 1px solid #000; border-right: 1px solid #000;">Item No.</th>
          ...
          <tbody>
            ...
            @endphp 
                  ...
                  <tr>
                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000;">{{ substr($o_pro->sku, -5) }}</td>
            ...
            <tr>
                <td colspan="4" style="border-right: 1px solid #000; text-align: right; font-weight: bold; min-height: 50px;">Total:</td>
